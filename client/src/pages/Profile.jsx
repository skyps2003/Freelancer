                        ...
                        {!isEditing && (
                            <div className="flex flex-col gap-3">
                                <button
                                    ...
                                    className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-6 py-2 rounded-lg hover:bg-emerald-500 hover:text-black transition text-sm font-bold flex items-center justify-center gap-2"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                                    Mi Billetera — S/ {(user?.wallet || 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                                </button>
                                <button
